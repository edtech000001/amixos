...
<head>
  ...
  <style>
    @page { margin: 14mm; }
    /* Long invoices must paginate — block flow lets content run onto page 2+ and
       renders the footer once, after the content on the last page (never on
       every page, never a stretched band). */
    @media print {
