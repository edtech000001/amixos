  ...
  es: {
    ...
    jobs: {
      ...
      detail: {
        ...
        emailSubject: 'Cotización {{numero}} | {{negocio}}',
    ...
    workspaces: {
      ...
      reorderHint: 'Mantén presionado para cambiar el orden.',
    ...
    modules: {
      ...
      map: {
        ...
        placeNoPins: 'Mostrando {{place}} — aquí no tienes pines. Te mostramos todos para ver qué hay cerca.',
  ...
  en: {
    ...
    jobs: {
      ...
      detail: {
        ...
        emailSubject: 'Estimate {{number}} | {{business}}',
    ...
    workspaces: {
      ...
      reorderHint: 'Press and hold to change the order.',
    ...
    modules: {
      ...
      map: {
        ...
        placeNoPins: 'Showing {{place}} — no pins here. Showing all your pins so you can see what is nearby.',
