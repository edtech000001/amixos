...
export const onboarding: Record<Locale, OnboardingDict> = {
  es: {
    ...
    serviceType: {
      ...
      sub: 'Nos ayuda a preparar tu cuenta.',
      options: [
        ...
        { key: 'hvac', label: 'Climatización / HVAC' },
        { key: 'roofing', label: 'Techos' },
        { key: 'painting', label: 'Pintura' },
        { key: 'fencing', label: 'Cercas' },
        { key: 'irrigation', label: 'Riego / Pivotes' },
        { key: 'concrete', label: 'Concreto' },
        { key: 'flooring', label: 'Pisos' },
        { key: 'welding', label: 'Soldadura' },
        { key: 'tree_service', label: 'Servicio de Árboles' },
        { key: 'pest_control', label: 'Control de Plagas' },
        { key: 'pressure_washing', label: 'Lavado a Presión' },
        { key: 'snow_removal', label: 'Remoción de Nieve' },
        { key: 'moving', label: 'Mudanzas' },
        { key: 'appliance_repair', label: 'Electrodomésticos' },
        { key: 'auto_detailing', label: 'Detallado de Autos' },
        { key: 'dealership', label: 'Concesionario' },
        { key: 'salon', label: 'Salón / Belleza' },
        { key: 'trainer', label: 'Entrenador / Gimnasio' },
        { key: 'events', label: 'Eventos / Bodas' },
        { key: 'photography', label: 'Fotografía' },
        { key: 'security', label: 'Seguridad / Alarmas' },
        { key: 'property_rental', label: 'Renta de Propiedades' },
  ...
  en: {
    ...
    serviceType: {
      ...
      sub: 'Helps us set your account up right.',
      options: [
        ...
        { key: 'irrigation', label: 'Irrigation / Pivots' },
