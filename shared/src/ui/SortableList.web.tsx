...
// Shared copy of the web sortable list, so screens in shared/ can use it —
// they cannot import from web's `@/` alias. @dnd-kit is hoisted to the repo
// root, so the import resolves from here.
//
// Drop-in vertical sortable list. Each item gets
